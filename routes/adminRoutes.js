...
router.post  ('/admin/usuario/:id/template/item',        ...guard, adminCtrl.adicionarItemTemplate);
router.delete('/admin/usuario/:id/template/item/:itemId',...guard, adminCtrl.removerItemTemplate);
